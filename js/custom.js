    ...
    *===================================*/
    ...
    $(document).ready(function() {
        ...
        $('#search-box').on('input', function() {
            ...
            if (query.length < 3) {
                $('#search-results').html(''); // Clear results for short queries
                return;
            }
    
            $.ajax({
                url: `/api/search?query=${query}`, // Replace with your actual API endpoint
                method: 'GET',
        ...
        // Optional: Prevent form submission if the user presses enter
